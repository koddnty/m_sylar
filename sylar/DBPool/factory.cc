...
MySQLPoolManager::ptr DB::createMysqlPool(int min_conn, int max_conn, bool is_public) {
...
MySQLPoolManager::ptr DB::Mysql::getInstance() {
    ...
    createMysqlPool(5, 15, true);
    return MySQLPoolInstance;
}


RedisPoolManager::ptr DB::createRedisPool(int min_conn, int max_conn, bool is_public) {
